    ...
    <div class="onboarding-wrap">
      <div class="onboarding-wrap-inner">
        ...
        <div class="onboarding-card">
          ...
          <img
            class="dark-image"
            src="/@dds/sets/illustrations/onboarding/set2-1-dark.svg"
            alt=""
          />
        ...
        <div class="onboarding-card">
          <img
            class="light-image"
            src="/@dds/sets/illustrations/onboarding/set2-2.svg"
            alt=""
          />
          <img
            class="dark-image"
            src="/@dds/sets/illustrations/onboarding/set2-2-dark.svg"
            alt=""
          />
          <div class="onboarding-content">
        ...
        <div class="onboarding-card">
          <img
            class="light-image"
            src="/@dds/sets/illustrations/onboarding/set2-3.svg"
            alt=""
          />
          <img
            class="dark-image"
            src="/@dds/sets/illustrations/onboarding/set2-3-dark.svg"
            alt=""
          />
          <div class="onboarding-content">
