...
import { classes } from '/@dds/data/layouts/flex-list-v3'
        ...
        >
          <template #image>
            <img
              ...
              src="/@dds/assets/illustrations/placeholders/courses.svg"
              alt=""
            />
            <img
              class="dark-image is-larger"
              src="/@dds/assets/illustrations/placeholders/courses-dark.svg"
              alt=""
            />
          </template>
        </VPlaceholderPage>
