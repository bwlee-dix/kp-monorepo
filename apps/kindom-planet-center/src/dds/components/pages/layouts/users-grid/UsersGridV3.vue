...
import { users } from '/@dds/data/layouts/user-grid-v3'
        ...
        >
          <template #image>
            <img
              ...
              src="/@dds/assets/illustrations/placeholders/team.svg"
              alt=""
            />
            <img
              class="dark-image is-larger"
              src="/@dds/assets/illustrations/placeholders/team-dark.svg"
              alt=""
            />
          </template>
        </VPlaceholderPage>
