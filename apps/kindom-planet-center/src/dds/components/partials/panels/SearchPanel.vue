...
import { type UserPopover } from '/@dds/models/users'
            ...
            <VBlock title="Browser Support" subtitle="Blog post" center>
              <template #icon>
                <VIconBox size="small" color="info" rounded>
                  <i aria-hidden="true" class="iconify" data-icon="feather:chrome" />
                </VIconBox>
              </template>
            </VBlock>
            <VBlock title="Twitch API" subtitle="Blog post" center>
              <template #icon>
                <VIconBox size="small" color="orange" rounded>
                  <i aria-hidden="true" class="iconify" data-icon="feather:tv" />
                </VIconBox>
              </template>
            </VBlock>
            <VBlock title="Browser Support" subtitle="Blog post" center>
              <template #icon>
                <VIconBox size="small" color="green" rounded>
                  <i aria-hidden="true" class="iconify" data-icon="feather:twitter" />
                </VIconBox>
              </template>
            </VBlock>
          </div>
