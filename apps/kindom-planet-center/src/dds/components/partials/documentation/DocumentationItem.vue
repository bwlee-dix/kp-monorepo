...
const githubIssueUrl = computed(() => {
  ...
  const issuePath = `https://github.com/cssninjaStudio/dds/issues/new`
  const sourceUrl = `https://github.com/cssninjaStudio/dds/tree/main${props.sourceMeta.relativePath}`
