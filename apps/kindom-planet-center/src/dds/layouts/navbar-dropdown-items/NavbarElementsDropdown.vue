    ...
    <template #content>
      <div class="category-selector" :class="[selectedCategory !== '' && 'is-hidden']">
        ...
        <div class="category-selector-inner">
          ...
          >
            <i aria-hidden="true" class="lnil lnil-pointer-top" />
          ...
          >
            <i aria-hidden="true" class="lnil lnil-Website" />
            <span>Advanced</span>
          </div>
          <!-- Addons Item -->
          <div
            ...
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                ...
                <RouterLink to="/elements/helpers" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-help" />
                  </div>
                  <div class="meta">
                    <span>Helpers</span>
                  </div>
                ...
                <RouterLink to="/elements/icons/iconify" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-minus" />
                  </div>
                  <div class="meta">
                    <span>Iconify</span>
                  </div>
            ...
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                ...
                <RouterLink to="/elements/dropdown" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-chevron-down" />
                  </div>
                  <div class="meta">
                    <span>VDropdown</span>
                  </div>
                ...
                <RouterLink to="/elements/loader" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-spinner-3" />
                  </div>
                  <div class="meta">
                    <span>VLoader</span>
                  </div>
                ...
                <RouterLink to="/elements/message" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-capital-letter" />
                  </div>
                  <div class="meta">
                    <span>VMessage</span>
                ...
                <RouterLink to="/elements/modal" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-top-right-arrow-box" />
                  </div>
                  <div class="meta">
                    <span>VModal</span>
                  </div>
                ...
                <RouterLink to="/elements/progress" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-half-battery" />
                  </div>
                  <div class="meta">
                    <span>VProgress</span>
                  </div>
                ...
                <RouterLink to="/elements/tooltip" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-comments-alt" />
                  </div>
                  <div class="meta">
                    <span>VTooltip</span>
                  </div>
            ...
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                <RouterLink to="/elements/forms/field" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-stop" />
                  </div>
                  <div class="meta">
                    <span>VField</span>
                ...
                <RouterLink to="/elements/forms/inputs" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-font" />
                  </div>
                  <div class="meta">
                    <span>VInput</span>
                    <VTag label="v2.3" color="primary" outlined curved class="ml-3" />
                ...
                <RouterLink to="/elements/checkbox" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-round-box-check" />
                  </div>
                  <div class="meta">
                    <span>VCheckbox</span>
                    <VTag label="v2.3" color="primary" outlined curved class="ml-3" />
                ...
                >
                  <div class="icon">
                    <i class="lnil lnil-star" aria-hidden="true" />
                  </div>
                  <div class="meta">
                ...
                <RouterLink to="/elements/forms/file" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-upload" />
                  </div>
                  <div class="meta">
            ...
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                ...
                <RouterLink to="/elements/switch-block" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-switch" />
                  </div>
                  <div class="meta">
