      ...
      >
        ...
        <div class="category-selector-inner">
          ...
          >
            <i
              aria-hidden="true"
              class="lnil lnil-boarding-pass-alt"
            />
            <span>Display</span>
          </div>
          <!-- Layout Item -->
