    ...
    >
      <ul>
        ...
        >
          ...
          <RouterLink
            to="/sidebar/layouts/grid-users-1"
            class="is-submenu"
          >
            <i
              aria-hidden="true"
