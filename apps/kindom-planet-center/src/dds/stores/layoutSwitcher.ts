...
import type { SidebarTheme } from '/@dds/components/navigation/desktop/Sidebar.vue'
...
export const useLayoutSwitcher = defineStore('layoutSwitcher', () => {
  ...
  const NavbarLayout = defineAsyncComponent({
    loader: () => import('/@dds/layouts/NavbarLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  const NavbarDropdownLayout = defineAsyncComponent({
    loader: () => import('/@dds/layouts/NavbarDropdownLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  const NavbarSearchLayout = defineAsyncComponent({
    loader: () => import('/@dds/layouts/NavbarSearchLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  ...
  const SidebarLayout = defineAsyncComponent({
    loader: () => import('/@dds/layouts/SidebarLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  const SideblockLayout = defineAsyncComponent({
    loader: () => import('/@dds/layouts/SideblockLayout.vue'),
    delay: 0,
    suspensible: false,
  })
