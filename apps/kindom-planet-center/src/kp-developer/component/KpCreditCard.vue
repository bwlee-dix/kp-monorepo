...
export interface KpCreditCardEmits {
  (e: 'flip'): void
}
export interface KpCreditCardProps {
  number?: string
  name?: string
  expiry?: string
  cvc?: string | number
...
const emit = defineEmits<KpCreditCardEmits>()
const props = withDefaults(defineProps<KpCreditCardProps>(), {
  color: 'grey',
  name: 'John Doe',
