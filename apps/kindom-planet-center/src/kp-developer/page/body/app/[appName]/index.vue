...
const appName = computed(() => (route.params as any).appName || '')

useHead({
  title: `${appName.value} - KingdomPlanet`,
})
...
const appDescription = ref<string>(`${appName.value} App`)
const appId = ref('9hga90wfq0wf8wehfi0asf')
const appKey = ref('12j1riufhweuh9wqef0iewqv')
const webUrl = ref(`https://${appName.value}.kingdompla.net`)
</script>
        ...
        <div class="form-body">
          ...
          <div class="form-fieldset">
            ...
            <div class="columns is-multiline">
              <div class="column is-12">
                <VField>
                  <VLabel>App Name</VLabel>
                  <VControl icon="feather:box">
                    <VInput
                      v-model:model-value="appName"
                      type="text"
              ...
              <div class="column is-12">
                <VField>
                  <VLabel>App Description</VLabel>
                  <VControl>
                    <VTextarea
                      v-model:model-value="appDescription"
                      rows="4"
          ...
          <div class="form-fieldset">
            ...
            <div class="columns is-multiline">
              <div class="column is-12">
                <VField>
                  <VLabel>WEB URL</VLabel>
                  <VControl icon="feather:box">
                    <VInput
                      v-model:model-value="webUrl"
                      type="text"
                      placeholder="app name"
                    />
                  </VControl>
