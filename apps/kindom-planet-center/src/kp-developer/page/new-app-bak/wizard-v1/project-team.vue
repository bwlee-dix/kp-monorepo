...
import type { WizardTeammate, WizardTeammateRole } from '/@dds/models/wizard'
import { users } from '/@dds/data/wizard'
...
wizard.setStep({
  ...
  previousStepFn: async () => {
    router.push('/new-app/wizard-v1/project-files')
  },
  validateStepFn: async () => {
    if (search.value) return

    router.push('/new-app/wizard-v1/project-tools')
  },
})
      ...
      >
        <template #image>
          <img
            ...
            src="/@dds/assets/illustrations/wizard/team-placeholder.svg"
            alt=""
          />
          <img
