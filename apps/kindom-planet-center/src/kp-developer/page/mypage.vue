          ...
          <div class="column is-3">
            <div class="account-box is-navigation">
              <VBlock
                ...
                :subtitle="userSession.user?.position ?? 'Software Engineer'"
                center
              >
                <template #icon>
                  <VAvatar
                ...
                <template #action>
                  <VButton icon="lucide:arrow-left" color="light" to="/body/dashboard">
                    Dev Center
                  </VButton>
                </template>
              </VBlock>
              ...
              <div class="account-menu">
                ...
                <RouterLink
                  ...
                  @selectstart.prevent
                >
                  <VIcon icon="lucide:award" class="icon" />
                  <span>Reward</span>
                </RouterLink>
              </div>
            </div>
