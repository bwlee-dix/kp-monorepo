...
import { useRevenueChart } from '/@dds/data/dashboards/analytics/revenueChart'
import { useGoalCharts } from '/@dds/data/dashboards/analytics/goalChart'
import { useProfitBarChart } from '/@dds/data/dashboards/analytics/profitBarChart'
import { useGrowthRadialChart } from '/@dds/data/dashboards/analytics/growthRadialChart'
      ...
      <div class="finance-dashboard analytics-dashboard">
          ...
          <div class="column is-9">
            <div class="columns is-multiline">
              ...
              <div class="column is-4">
                <div class="dashboard-card">
                  <div class="card-head">
                    <h3 class="dark-inverted">DAU / MAU</h3>
                  </div>
        ...
        <div class="rows">
          <div class="column is-8">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">API 사용량</h3>
              </div>
              <div class="revenue-stats">
                <div class="revenue-stat">
                  <span>This Month</span>
