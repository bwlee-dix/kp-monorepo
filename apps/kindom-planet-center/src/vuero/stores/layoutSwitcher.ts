...
export const useLayoutSwitcher = defineStore('layoutSwitcher', () => {
  ...
  const NavbarLayout = defineAsyncComponent({
    loader: () => import('/@vuero/layouts/NavbarLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  const NavbarDropdownLayout = defineAsyncComponent({
    loader: () => import('/@vuero/layouts/NavbarDropdownLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  const NavbarSearchLayout = defineAsyncComponent({
    loader: () => import('/@vuero/layouts/NavbarSearchLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  ...
  const SidebarLayout = defineAsyncComponent({
    loader: () => import('/@vuero/layouts/SidebarLayout.vue'),
    delay: 0,
    suspensible: false,
  })
  const SideblockLayout = defineAsyncComponent({
    loader: () => import('/@vuero/layouts/SideblockLayout.vue'),
    delay: 0,
    suspensible: false,
  })
