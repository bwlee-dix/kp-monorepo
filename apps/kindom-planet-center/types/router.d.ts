...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/event/registration/': RouteRecordInfo<'/event/registration/', '/event/registration', Record<never, never>, Record<never, never>>,
    '/event/registration/[registrationId]/': RouteRecordInfo<'/event/registration/[registrationId]/', '/event/registration/:registrationId', { registrationId: ParamValue<true> }, { registrationId: ParamValue<false> }>,
